...
graphical diff of the assembly before and after a change is often very enlightening.
...
<encoding-of-the-metadata-hash-in-the-bytecode>`. The comments in the assembly output points to the
